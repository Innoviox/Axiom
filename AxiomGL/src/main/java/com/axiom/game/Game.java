...
public class Game implements IGame {
    ...
    @Override
    public void input(Window window, MouseListener mouseInput, KeyboardListener keyboardInput) {
        cameraInc.set(0, 0, 0);
        if (keyboardInput.keyDown(GLFW_KEY_W)) {
            cameraInc.z = -1;
        } else if (keyboardInput.keyDown(GLFW_KEY_S)) {
            cameraInc.z = 1;
        }
        if (keyboardInput.keyDown(GLFW_KEY_A)) {
            cameraInc.x = -1;
        } else if (keyboardInput.keyDown(GLFW_KEY_D)) {
            cameraInc.x = 1;
        }
        if (keyboardInput.keyDown(GLFW_KEY_Z)) {
            cameraInc.y = -1;
        } else if (keyboardInput.keyDown(GLFW_KEY_X)) {
            cameraInc.y = 1;
        }
        int mult;
        ...
        moving2 = keyboardInput.keyDown(GLFW_KEY_M);
    ...
    @Override
    public void update(float interval, MouseListener mouseInput, KeyboardListener keyboardInput) {
    		n++;
