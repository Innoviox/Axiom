...
public final class InputHandler
{
    ...
    public GLFWMouseButtonCallback mouse = new GLFWMouseButtonCallback()
    {
        public void invoke(long window, int button, int action, int mods)
        {
            ...
            getMouseButtonStates()[button] = action;
        }
    };
    ...
    public boolean keyDown(int key) {return activeKeys[key];}

    public boolean keyPressed(int key) {return keyStates[key] == GLFW_PRESS;}

    public boolean keyReleased(int key) {return keyStates[key] == GLFW_RELEASE;}

    public boolean mouseButtonDown(int button) {return activeMouseButtons[button];}

    public boolean mouseButtonPressed(int button) {return getMouseButtonStates()[button] == GLFW_RELEASE;}
